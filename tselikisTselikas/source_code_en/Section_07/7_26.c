...
int main()
{
	...
	min_pos = max_pos = 0;
	max_avg_grd = 0; /* Initialization with the minimum allowed value. */
	min_avg_grd = 10; /* Initialization with the maximum allowed value. */
	for(i = 0; i < STUDS; i++)
	{
		sum = 0;
		max_grd = 0; 
